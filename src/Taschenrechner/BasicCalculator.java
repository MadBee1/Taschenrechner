...
public class BasicCalculator extends JFrame {
	...
	public BasicCalculator() {
		...
		btnPercent.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// String percent = textField.getText() + btnPercent.getText(); //saves previous
				// input
				// String text = textField.getText();
		...
		btnMinus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// String minus = textField.getText() + btnMinus.getText(); //saves previous
				// input
				// String text = textField.getText();
		...
		btnDiv.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// String divide = textField.getText() + btnDiv.getText(); //saves previous
				// input
				// String text = textField.getText();
